[![Travis build status shield](https://img.shields.io/travis/drazik/cozy-music/master.svg)](https://travis-ci.org/drazik/cozy-music)
[![Github Release version shield](https://img.shields.io/github/tag/drazik/cozy-music.svg)](https://github.com/drazik/cozy-music/releases)
...
```sh
$ git clone https://github.com/drazik/cozy-music.git
$ cd cozy-music
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://cozy-music.cozy.tools:8080.
...
The lead maintainer for Cozy music is [drazik](https://github.com/drazik), send him/her a :beers: to say hello!
...
Cozy music is developed by drazik and distributed under the [AGPL v3 license][agpl-3.0].
